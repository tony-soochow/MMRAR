...
def _make_dataset(
        episodes, model, phi, batch_states, obs_normalizer, gamma, lambd,
):
...
class PPO(agent.AttributeSavingMixin, agent.BatchAgent):
    ...
    def batch_act_and_train(self, batch_obs):
        ...
        min_actions = adversarl_attack(batch_action, action_distrib.mean, action_distrib.ln_var,
